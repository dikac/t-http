(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dikac/t-string/boolean/string", "@dikac/t-object/property/boolean/property", "@dikac/t-object/boolean/object", "@dikac/t-enum/boolean/enum", "../method/method/method"], factory);
    }
    ...
    function Request(value) {
        ...
        if (!property_1.default(value, 'path') || !string_1.default(value.path)) {
            return false;
        }
        if (!property_1.default(value, 'method') || !enum_1.default(value.method, method_1.default)) {
            return false;
        }
        return true;
    }
