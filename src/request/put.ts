...
export default function Put<Body, Path extends string,Header extends Record<string, string>>
    (body : Body, path : Path, header : Header) : Request<Method.PUT, Path, Header, Body>;
...
>(
    ...
    path : Path,
    header ?: Header
) : Request<Method.PUT, Path, Header|{}, Body> {
